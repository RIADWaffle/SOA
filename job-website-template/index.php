...
<html lang="en">
  ...
  <head>
    ...
    <title>Job Agency Website</title>
          ...
          <div class="col-md-9">
            ...
            <script>
                ...
                fetch('method.php')
                    ...
                    .then(data => {
                        const row = document.getElementById('jovs');
                        ...
                        <div class="product-item">
                          <a href="job-details.html"><img src="${item.img}" alt=""></a>
                          <div class="down-content">
                            <a href="job-details.html"><h4>${item.name}</h4></a>

                            <h6>${item.salary}</h6>

                            <h4><small><i class="fa fa-briefcase"></i> ${item.type} <br> <strong><i class="fa fa-building"></i> ${item.place}</strong></small></h4>
                            <div class="product-item" style="border: 0;">
                            <button id="delete" class="btn btn-danger" onclick='eliminarFila(${item.id})'> Delete Job</button>
                            <a id="update" href="update.php?id=${item.id}&img=${item.img}&name=${item.name}&salary=${item.salary}&type=${item.type}&place=${item.place}" class="btn btn-warning" )> Update Job</a>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <script>
                function eliminarFila(id) {
                    // Solicitar la eliminación al servidor mediante una petición AJAX
            ...
            <div class="container">
              <h4 style="text-align: center;">Looking for chambeadores?</h4>
              <br>
              <div class="contact-form">
              <div class="form-group">
                <a href="job-publish.php" class="filled-button btn-block" style="text-align: center;">Publish your work</a>
              </div>
              <br><br>
            </div>
            </div>
